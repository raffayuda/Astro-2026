...
export const competitions = pgTable(
  "competitions",
  {
    ...
    // '1' = setiap pemain (ketua + anggota) wajib mengunggah foto dan ID akun
    // in-game, mis. esports seperti Mobile Legends
...
export const registrations = pgTable(
  "registrations",
  {
    ...
    // ID akun in-game ketua — dipakai lomba esports (mis. Mobile Legends)
    leaderGameId: text("leader_game_id"),
    ...
    memberDetails: jsonb("member_details")
      .$type<{ name: string; gameId: string | null; photoUrl: string | null }[]>()
      .default([])
      .notNull(),
    // Common fields
