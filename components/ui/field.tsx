...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-1.5 font-bold text-astro-navy data-[variant=label]:text-sm data-[variant=legend]:text-base",
        className
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-sm font-semibold text-astro-navy group-data-[disabled=true]/field:opacity-50",
        className
      )}
      {...props}
    />
